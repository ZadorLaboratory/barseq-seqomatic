...
class SeqomaticGUI(tk.Tk):
    ...
    Also serves as central Controller object, allowing access 
    to all sub-components, and keeping global Tk and native Python
    variables. 
    ...
    def __init__(self):
        ...
        # For now, make this root Tk() object.
...
class AutomationFrame(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.device_btn = tk.Button(self.lbf, 
                                    ...
                                    command=self.controller.config_device,
                                    bd=widget_attr.NORMAL_EDGE, 
                                    fg=widget_attr.NORMAL_COLOR)
...
class ProcessBuilder(tk.Tk):
    ...
    def confirm_option(self):
        ...
        self.controller.add_highlight_mainwindow(txt)
        self.destroy()
