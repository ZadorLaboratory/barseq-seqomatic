...
class MainWindow():        
    ...
    def __init__(self, cp=None):
        ...
        self.notification_stw = tk.scrolledtext.ScrolledText(
            master=self.frame,
            wrap=tk.WORD,
            width=45,
            height=10,
        )
        self.notification_lb = tk.Label(self.frame, 
        ...
        self.warning_lb = tk.Label(self.frame, 
                                   text="System warning", 
                                   bd=1, 
                                   relief="groove", 
                                   width=15,
        ...
        self.liveview_lb = tk.Label(self.frame, 
                                    ...
                                    fg=widget_attr.BLACK_COLOR, 
                                    font=("Arial", 10))
        self.liveview_lb.grid(row=5, column=0,pady=3,padx=3)

        self.frame1 = tk.Frame(self.frame, bg=self.mainwindow.cget('bg'))
        ...
        self.progressbar1 = tk.ttk.Progressbar( self.frame1, 
                                                mode = 'indeterminate',
                                                length=250)
        ...
        self.canvas_live.get_tk_widget().grid(row=6, 
                                              column=0, 
                                              padx=3, 
                                              pady=3, 
                                              sticky="w")
...
class WindowWidgets:
    ...
    def __init__(self, mainwindow, tkapp, path):
        ...
        self.notebook = tk.ttk.Notebook(self.frame0)
        self.notebook.grid(row=0, column=0)
        self.cwd=os.getcwd()

        self.auto_tab = tk.ttk.Frame(self.notebook)
        self.manual_tab = tk.ttk.Frame(self.notebook)
        ...
        ##label group
        self.work_path_lb_auto = tk.Label(self.section1_lbf_auto, text="Select your work directory:", bd=1, relief="flat", width=20,
                                  fg=widget_attr.BLACK_COLOR, font=("Arial", 10))
        self.work_path_lb_manual = tk.Label(self.section1_lbf_manual, text="Select your work directory:", bd=1, relief="flat",
                                       width=20,fg=widget_attr.BLACK_COLOR, font=("Arial", 10))

        self.slice_per_slide_lb_auto = tk.Label(self.frame1, text="Slice per slide:", bd=1, relief="flat", width=15,
                                        fg=widget_attr.BLACK_COLOR, font=("Arial", 10))

        self.slice_per_slide_lb_manual = tk.Label(self.frame1_1, text="Slice per slide:", bd=1, relief="flat", width=15,
                                             fg=widget_attr.BLACK_COLOR, font=("Arial", 10))

        self.OR_lb = tk.Label(self.frame1, text="OR", bd=1, relief="flat", width=3,
                           fg=widget_attr.BLACK_COLOR, font=("Arial", 10))

        self.server_account_lb_auto = tk.Label(self.frame2, text="server account:", bd=1, relief="flat", width=10,
                                       fg=widget_attr.DISABLE_COLOR, font=("Arial", 10))

        self.server_lb_auto = tk.Label(self.frame2, text="server name:", bd=1, relief="flat", width=10,
                               fg=widget_attr.DISABLE_COLOR, font=("Arial", 10))

        self.server_account_lb_manual = tk.Label(self.frame2_2, text="server account:", bd=1, relief="flat", width=10,
                                            fg=widget_attr.DISABLE_COLOR, font=("Arial", 10))

        self.server_lb_manual = tk.Label(self.frame2_2, text="server name:", bd=1, relief="flat", width=10,
                                    fg=widget_attr.DISABLE_COLOR, font=("Arial", 10))

        self.aws_account_lb_auto = tk.Label(self.frame3, text="AWS account:", bd=1, relief="flat", width=12,
                                    fg=widget_attr.DISABLE_COLOR, font=("Arial", 10))

        self.aws_password_lb_auto = tk.Label(self.frame3, text="AWS password:", bd=1, relief="flat", width=15,
                                     fg=widget_attr.DISABLE_COLOR, font=("Arial", 10))

        self.aws_account_lb_manual = tk.Label(self.frame3_3, text="AWS account:", bd=1, relief="flat", width=12,
                                         fg=widget_attr.DISABLE_COLOR, font=("Arial", 10))

        self.aws_password_lb_manual = tk.Label(self.frame3_3, text="AWS password:", bd=1, relief="flat", width=15,
                                          fg=widget_attr.DISABLE_COLOR, font=("Arial", 10))
        ...
        self.tile_lb = tk.Label(self.frame7, text="Tiles", bd=1, relief="flat", width=15,
                              fg=widget_attr.BLACK_COLOR, font=("Arial", 10))
        self.note_lb = tk.Label(self.section4_addtion_note, text="Notes", bd=1, relief="flat", width=15,
                              fg=widget_attr.BLACK_COLOR, font=("Arial", 10))

        self.current_cycle_lb=tk.Label(self.frame1_1, text="Current Cycle:", bd=1, relief="flat", width=15,
                              fg=widget_attr.BLACK_COLOR, font=("Arial", 10))

        #button group
        self.browse_btn_auto = tk.Button(self.section1_lbf_auto, 
                                         text="Browse", 
                                         command=self.browse_handler_auto,
                                         bd=widget_attr.NORMAL_EDGE, 
                                         fg=widget_attr.NORMAL_COLOR)
        self.exp_btn_auto = tk.Button(self.section1_lbf_auto, 
                                      text="Fill experiment detail", 
                                      command=self.exp_btn_handler, 
                                      width=18,
                                      bd=widget_attr.NORMAL_EDGE, 
                                      fg=widget_attr.NORMAL_COLOR)
        self.browse_btn_manual = tk.Button(self.section1_lbf_manual, 
                                           text="Browse", 
                                           command=self.browse_handler_manual,
                                           bd=widget_attr.NORMAL_EDGE, 
                                           fg=widget_attr.NORMAL_COLOR)
        self.exp_btn_manual = tk.Button(self.section1_lbf_manual, 
                                        text="Fill experiment detail", 
                                        command=self.exp_btn_handler,
                                        width=18,
                                        bd=widget_attr.NORMAL_EDGE, 
                                        fg=widget_attr.NORMAL_COLOR)
        self.recipe_btn = tk.Button(self.frame1, 
                                    text="Create Protocol", 
                                    command=self.recipe_btn_handler,
                                    bd=widget_attr.NORMAL_EDGE, 
                                    fg=widget_attr.NORMAL_COLOR)
        self.assign_heater_btn = tk.Button(self.frame1, 
                                           text="Assign Heaters", 
                                           command=self.assign_heater,
                                           bd=widget_attr.NORMAL_EDGE, 
                                           fg=widget_attr.NORMAL_COLOR)
        self.info_btn_auto = tk.Button(self.auto_tab, 
                                       text="Create Your Experiment",
                                       command=self.create_exp_auto,
                                       bd=widget_attr.NORMAL_EDGE, 
                                       fg="#1473cc")

        self.info_btn_manual = tk.Button(self.manual_tab, 
                                         text="Create Your Experiment", 
                                         command=self.create_exp_manual,
                                         bd=widget_attr.NORMAL_EDGE, 
                                         fg="#1473cc")
        ...
        self.note_btn = tk.Button(self.section4_addtion_note, text="Send note to server", command=self.save_to_note,
                               bd=widget_attr.NORMAL_EDGE, fg=widget_attr.NORMAL_COLOR)
        ...
        self.work_path_field_auto = tk.Entry(self.section1_lbf_auto, relief="groove", width=43)
        self.work_path_field_manual = tk.Entry(self.section1_lbf_manual, relief="groove", width=35)

        self.pixel_size = tk.StringVar()
        self.pixel_size.set("0.33")
        self.pixel_size_field_auto = tk.Entry(self.frame2, relief="groove", width=6, textvariable=self.pixel_size)
        self.pixel_size_field_auto.config(state=tk.DISABLED)
        self.pixel_size_field_manual = tk.Entry(self.frame2_2, relief="groove", width=6, textvariable=self.pixel_size)
        self.pixel_size_field_manual.config(state=tk.DISABLED)

        self.slice_number_field_auto = tk.Entry(self.frame1, relief="groove", width=10)
        self.slice_number_field_manual = tk.Entry(self.frame1_1, relief="groove", width=10)

        self.account = tk.StringVar()
        self.account.set("imagestorage")
        self.account_field_auto = tk.Entry(self.frame2, relief="groove", width=15, textvariable=self.account)
        self.account_field_auto.config(state=tk.DISABLED)
        self.account_field_manual = tk.Entry(self.frame2_2, relief="groove", width=15, textvariable=self.account)
        self.account_field_manual.config(state=tk.DISABLED)

        self.server = tk.StringVar()
        self.server.set(r"N:\\")
        self.server_field_auto = tk.Entry(self.frame2, relief="groove", width=20, textvariable=self.server)
        self.server_field_auto.config(state=tk.DISABLED)
        self.server_field_manual = tk.Entry(self.frame2_2, relief="groove", width=20, textvariable=self.server)
        self.server_field_manual.config(state=tk.DISABLED)

        self.aws = tk.StringVar()
        self.aws_account_field_auto = tk.Entry(self.frame3, relief="groove", width=20, textvariable=self.aws)
        self.aws_account_field_auto.config(state=tk.DISABLED)
        self.aws_account_field_manual = tk.Entry(self.frame3_3, relief="groove", width=20, textvariable=self.aws)
        self.aws_account_field_manual.config(state=tk.DISABLED)

        self.aws_pwd = tk.StringVar()
        self.aws_pwd_field_auto = tk.Entry(self.frame3, relief="groove", width=20, textvariable=self.aws_pwd)
        self.aws_pwd_field_auto.config(state=tk.DISABLED)
        self.aws_pwd_field_manual = tk.Entry(self.frame3_3, relief="groove", width=20, textvariable=self.aws_pwd)
        self.aws_pwd_field_manual.config(state=tk.DISABLED)
        ##check box
        ...
        self.mock_alignment_cbox = tk.Checkbutton(self.frame1, text="Skip Alignment",
                                               fg=widget_attr.NORMAL_COLOR, variable=self.mock_alignment, onvalue=1,
                                               offvalue=0)
        self.mock_alignment_cbox_manual = tk.Checkbutton(self.frame1_1, text="Skip Alignment",
                                               fg=widget_attr.NORMAL_COLOR, variable=self.mock_alignment, onvalue=1,
                                               offvalue=0)

        self.build_own_cycle_sequence_value = tk.IntVar()
        self.build_own_cycle_sequence_value.set(0)
        self.build_own_cycle_sequence = tk.Checkbutton(self.frame1, text="Use protocol in work directory",
                                                    fg=widget_attr.NORMAL_COLOR,
        ...
        self.change_pixel_auto = tk.Checkbutton(self.frame2, text="change pixel size", command=self.change_pixel_handler_auto,
                                        fg=widget_attr.NORMAL_COLOR, variable=self.change_pixel_value, onvalue=1,
                                        offvalue=0)
        self.change_pixel_manual = tk.Checkbutton(self.frame2_2, text="change pixel size",
        ...
        self.change_server_auto_cb = tk.Checkbutton(self.frame2, text="change storage server",
                                              command=self.change_server_auto,
                                              fg=widget_attr.NORMAL_COLOR, variable=self.change_server_value, onvalue=1,
                                              offvalue=0)
        self.change_server_manual_cb = tk.Checkbutton(self.frame2_2, text="change storage server",
        ...
        self.upload_aws_auto = tk.Checkbutton(self.frame3, text="upload to AWS", command=self.upload_to_aws_auto,
                                      fg=widget_attr.NORMAL_COLOR, variable=self.upload_aws_value, onvalue=1, offvalue=0)
        self.upload_aws_manual = tk.Checkbutton(self.frame3_3, text="upload to AWS", command=self.upload_to_aws_manual,
                                           fg=widget_attr.NORMAL_COLOR, variable=self.upload_aws_value, onvalue=1,
                                           offvalue=0)
        ...
        self.current_cbox = tk.ttk.Combobox(self.frame1_1, 
                                            textvariable=self.current_c, width=8)
        self.current_cbox['value'] = ['geneseq', 'hyb', 'bcseq']
        self.current_cbox['state'] = "readonly"
        ## spinner
        self.reagent_amount = tk.Spinbox(self.frame5, from_=0.5, to=10, state="readonly", increment=0.5, width=5)
        self.sb1_cycle_number = tk.Spinbox(self.frame1_1, from_=0, to=50, state="readonly", width=5)
        # canvas
        ...
        ## text field
        self.note_stw = tk.scrolledtext.ScrolledText(
    ...
    def set_widget_state(self):
        ...
        self.slice_per_slide_lb_auto.grid(row=0, column=0, padx=5,sticky="w")
        self.slice_number_field_auto.grid(row=0, column=1, padx=1,sticky="w")
        self.slice_per_slide_lb_manual.grid(row=0, column=0, padx=5,sticky="w")
        self.slice_number_field_manual.grid(row=0, column=1, padx=1,sticky="w")
        
        self.mock_alignment_cbox.grid(row=0, column=2, padx=5, sticky="w")
        self.mock_alignment_cbox_manual.grid(row=0, column=2, padx=5, sticky="w")
        self.current_cycle_lb.grid(row=0, column=3, padx=5, sticky="w")
        self.current_cbox.grid(row=0, column=4, padx=5, sticky="w")
        self.sb1_cycle_number.grid(row=0, column=5, padx=5, sticky="w")
        
        self.build_own_cycle_sequence.grid(row=0, column=3, padx=5, sticky="w")
        self.OR_lb.grid(row=0, column=4, padx=5, sticky="w")
        self.recipe_btn.grid(row=0, column=5, padx=5, sticky="w")
        self.assign_heater_btn.grid(row=0, column=6, padx=5, sticky="w")
        
        
        self.change_pixel_auto.grid(row=1, column=0, padx=5, sticky="w")
        self.change_pixel_manual.grid(row=1, column=0, padx=5, sticky="w")
        self.pixel_size_field_auto.grid(row=1, column=1, padx=5, sticky="w")
        self.pixel_size_field_manual.grid(row=1, column=1, padx=5, sticky="w")
        self.change_server_auto_cb.grid(row=1, column=2, padx=5, sticky="w")
        self.change_server_manual_cb.grid(row=1, column=2, padx=5, sticky="w")
        self.server_account_lb_auto.grid(row=1, column=3, padx=5, sticky="w")
        self.account_field_auto.grid(row=1, column=4, padx=5, sticky="w")
        self.server_lb_auto.grid(row=1, column=5, padx=5, sticky="w")
        self.server_field_auto.grid(row=1, column=6, padx=5, sticky="w")
        self.server_account_lb_manual.grid(row=1, column=3, padx=5, sticky="w")
        self.account_field_manual.grid(row=1, column=4, padx=5, sticky="w")
        self.server_lb_manual.grid(row=1, column=5, padx=5, sticky="w")
        self.server_field_manual.grid(row=1, column=6, padx=5, sticky="w")
        
        
        
        self.upload_aws_auto.grid(row=0, column=0, padx=5, sticky="w")
        self.aws_account_lb_auto.grid(row=0, column=1, padx=5, sticky="w")
        self.aws_account_field_auto.grid(row=0, column=2, padx=5,sticky="w")
        self.aws_password_lb_auto.grid(row=0, column=3, padx=5, sticky="w")
        self.aws_pwd_field_auto.grid(row=0, column=4, padx=5, sticky="w")
        
        self.upload_aws_manual.grid(row=0, column=0, padx=5, sticky="w")
        self.aws_account_lb_manual.grid(row=0, column=1, padx=5, sticky="w")
        self.aws_account_field_manual.grid(row=0, column=2, padx=5,sticky="w")
        self.aws_password_lb_manual.grid(row=0, column=3, padx=5, sticky="w")
        self.aws_pwd_field_manual.grid(row=0, column=4, padx=5, sticky="w")
        
        self.info_btn_auto.grid(row=2, column=0, padx=10, pady=5)
        self.info_btn_manual.grid(row=2, column=0, padx=10, pady=5)
        
        
        self.device_btn.grid(row=0, column=0, padx=10,sticky="w")
        self.brain_btn.grid(row=0, column=1, padx=10, sticky="w")
        self.prime_btn.grid(row=0, column=2, padx=10,sticky="w")
        self.fill_lb.grid(row=0, column=3, padx=10, sticky="w")
        self.reagent_list_cbox.grid(row=0, column=4, padx=10, sticky="w")
        self.reagent_amount.grid(row=0, column=5, padx=10, sticky="w")
        self.inchamber_path_cbox.grid(row=0, column=6, padx=10,sticky="w")
        self.fill_single_btn.grid(row=0, column=7, padx=10, sticky="w")
        
        self.start_sequence_btn.grid(row=0, column=1, padx=10, sticky="w")
        self.cancel_sequence_btn.grid(row=0, column=2, padx=10, sticky="w")
        self.wash_btn.grid(row=0, column=3, padx=10, sticky="w")
        self.avoid_wash_cbox.grid(row=0, column=4, padx=10, sticky="w")
        self.check_sequence_btn.grid(row=0, column=0, padx=10, sticky="w")
        
        self.canvas_focus.get_tk_widget().grid(row=1, column=0,padx=10,sticky="w")
        self.canvas_align.get_tk_widget().grid(row=1, column=1,padx=10,sticky="w")
        self.canvas_tile.get_tk_widget().grid(row=1, column=2,padx=10,sticky="w")
        
        self.focus_lb.grid(row=0, column=0,padx=5,pady=3)
        self.align_lb.grid(row=0, column=1,padx=5,pady=3)
        self.tile_lb.grid(row=0, column=2,padx=5,pady=3)
        ...
        self.browse_btn_manual.grid(row=0, column=15, padx=10, sticky="w")
        self.exp_btn_manual.grid(row=0, column=25, padx=10, sticky="w")
        
        self.focus_btn.grid(row=0, column=0, padx=10, pady=10)
        self.align_btn.grid(row=0, column=1, padx=10, pady=10)
        self.tile_btn.grid(row=0, column=2, padx=10, pady=10)
        self.max_btn.grid(row=0, column=3, padx=10, pady=10)
        self.cancel_image_btn.grid(row=0, column=4, padx=10, pady=10)    
    ...
    def search_for_file_path(self):
        ...
        self.tempdir = filedialog.askdirectory(parent=self.main, 
    ...
    def recipe_btn_handler(self):
        self.pb = ProcessBuilder( parent_window=self.parent_window )
    ...
    def change_pixel_handler_auto(self):
        if self.change_pixel_value.get() == 1:
            self.pixel_size_field_auto.config(state=tk.NORMAL)
        else:
    ...
    def change_pixel_handler_manual(self):
        if self.change_pixel_value.get() == 1:
            self.pixel_size_field_manual.config(state=tk.NORMAL)
        else:
    ...
    def change_server_manual(self):
       if self.change_server_value.get() == 1:
            self.server_account_lb_manual.config(fg=widget_attr.NORMAL_COLOR)
            self.server_lb_manual.config(fg=widget_attr.NORMAL_COLOR)
            self.server_field_manual["state"]="normal"
            self.account_field_manual["state"]="normal"
       else:
           self.server_account_lb_manual.config(fg=widget_attr.DISABLE_COLOR)
           self.server_lb_manual.config(fg=widget_attr.DISABLE_COLOR)
    ...
    def upload_to_aws_manual(self):
        if self.upload_aws_value.get() == 1:
            self.aws_account_lb_manual.config(fg=widget_attr.NORMAL_COLOR)
            self.aws_password_lb_manual.config(fg=widget_attr.NORMAL_COLOR)
            self.aws_account_field_manual["state"] = "normal"
            self.aws_pwd_field_manual["state"] = "normal"
        else:
            self.aws_account_lb_manual.config(fg=widget_attr.DISABLE_COLOR)
            self.aws_password_lb_manual.config(fg=widget_attr.DISABLE_COLOR)
    ...
    def create_exp_auto(self):
        ...
        self.cancel = 0
        self.skip_alignment = self.mock_alignment.get()
        self.warning_stw.delete('1.0', END)
        if self.work_path_field_auto.get() == "":
            tk.messagebox.showinfo(title="Wrong Input", message="work directory can't be empty")
            return
