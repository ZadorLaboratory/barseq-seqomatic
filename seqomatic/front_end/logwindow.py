...
class Log_window:
        ...
        warning_stw = tk.scrolledtext.ScrolledText(
            master=frame,
            wrap=tk.WORD,
            width=45,
            height=4,
        ...
        notification_stw = tk.scrolledtext.ScrolledText(
            master=frame,
            wrap=tk.WORD,
            width=45,
            height=10,
        )
        notification_lb = tk.Label(frame, text="System Notification", bd=1, relief="groove", width=15,
                                     fg=widge_attr.black_color, font=("Arial", 10))
        notification_lb.grid(row=2, column=0)

        warning_lb = tk.Label(frame, text="System warning", bd=1, relief="groove", width=15,
                                fg=widge_attr.black_color, font=("Arial", 10))
        warning_lb.grid(row=0, column=0,pady=3,padx=3)
        liveview_lb = tk.Label(frame, text="Live view of Barcodes", bd=1, relief="groove", width=15,
                           fg=widge_attr.black_color, font=("Arial", 10))
        ...
        process="Process"
        process_lable = tk.Label(frame1, text=process, bd=1, relief="flat", width=18,
                                             fg=widge_attr.black_color, font=("Arial", 10))
        process_lable.grid(row=0, column=0,pady=3)
        progressbar1 = tk.ttk.Progressbar( frame1,mode = 'indeterminate',length=250)
