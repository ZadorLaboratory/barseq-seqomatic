...
class scope():
    ...
    def create_max_projection_folder(self):
        ...
        # if not os.path.exists(os.path.join(self.linux_server,self.pos_path[3:]+"_maxprojection")):
        #     os.mkdir(os.path.join(self.linux_server,self.pos_path[3:]+"_maxprojection"))
