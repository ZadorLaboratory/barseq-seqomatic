...
class window_widgets:
    ...
    def __init__(self, mainwindow, path):
        ...
        #button group
        self.browse_btn_auto = tk.Button(self.section1_lbf_auto, text="Browse", command=self.browse_handler_auto,
                                 bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        self.exp_btn_auto = tk.Button(self.section1_lbf_auto, text="Fill experiment detail", command=self.exp_btn_handler, width=18,
                              bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        self.browse_btn_manual = tk.Button(self.section1_lbf_manual, text="Browse", command=self.browse_handler_manual,
                                      bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        self.exp_btn_manual = tk.Button(self.section1_lbf_manual, text="Fill experiment detail", command=self.exp_btn_handler,
                                   width=18,bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        self.recipe_btn = tk.Button(self.frame1, text="Create Protocol", command=self.recipe_btn_handler,
                                 bd=widge_attr.normal_edge, fg=widge_attr.normal_color)

        self.assign_heater_btn = tk.Button(self.frame1, text="Assign Heaters", command=self.assign_heater,
                                 bd=widge_attr.normal_edge, fg=widge_attr.normal_color)

        self.info_btn_auto = tk.Button(self.auto_tab, text="Create Your Experiment",command=self.create_exp_auto,
                               bd=widge_attr.normal_edge, fg="#1473cc")

        self.info_btn_manual = tk.Button(self.manual_tab, text="Create Your Experiment", command=self.create_exp_manual,
                                    bd=widge_attr.normal_edge, fg="#1473cc")

        self.device_btn = tk.Button(self.frame5, text="Devices configuration", command=self.config_device,
                                 bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        self.device_btn["state"] = "disable"
        self.brain_btn = tk.Button(self.frame5, text="Tissue Scanner (optional)", command=self.scan_tissue,
                                bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        self.brain_btn["state"] = "disable"
        self.prime_btn = tk.Button(self.frame5, text="Prime lines", command=self.prime_btn_handler,
                                bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        self.prime_btn["state"] = "disable"
        self.fill_single_btn = tk.Button(self.frame5, text="Fill", command=self.fill_single_reagent,
                                      bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        self.fill_single_btn["state"] = "disable"

        self.start_sequence_btn = tk.Button(self.frame6, text="Start Automation process",command=self.start_btn_handler,
                                         bd=widge_attr.normal_edge, fg=widge_attr.normal_color)
        ...
        self.cancle_image_btn = tk.Button(self.section3_lbf_manual, text="Cancel image process", command=self.cancel_manual_process,
                                       bd=widge_attr.normal_edge, fg=widge_attr.warning_color)
        ...
        self.reagent_list_cbox = tk.ttk.Combobox(self.frame5, textvariable=self.reagent, width=8)
        ...
        self.current_cbox = tk.ttk.Combobox(self.frame1_1, textvariable=self.current_c, width=8)
    ...
    def assign_heater(self):
        ...
        self.slide_heater1.config(state=tk.tk.DISABLED)
        ...
        self.slide_heater2.config(state=tk.tk.DISABLED)
        ...
        self.slide_heater3.config(state=tk.tk.DISABLED)
    ...
    def change_pixel_handler_auto(self):
        if self.change_pixel_value.get() == 1:
            ...
            self.pixel_size_field_auto.config(state=tk.tk.DISABLED)
    ...
    def change_pixel_handler_manual(self):
        if self.change_pixel_value.get() == 1:
            ...
            self.pixel_size.set(t)
            self.pixel_size_field_manual.config(state=tk.tk.DISABLED)
